...
; query fazendo um "join"entre duas entidades produto e categoria(Keys para mostrar apenas o mapa)
...
;exemplo com foward navigation
; ?produto :produto/categoria >>>>>>> referencia
(defn todos-os-produtos-da-categoria-foward [db nome-da-categoria]
...
;quem referencia>>>>>>>>> :produtio/_categoria ?categoria
...
;           :where [?produto :produto/preco ?preco]]
;         db preco-mais-alto)))
;nested querie uma dentro da outra e oq sai de uma querie para outra
(defn todos-os-produtos-mais-caros [db]
  (d/q '[:find (pull ?produto [*])
